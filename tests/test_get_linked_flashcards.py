...
from src.tools.get_linked_flashcards import _run, _find_flashcards_in_blocks, _extract_flashcard_question
...
class TestFindFlashcards:
    def test_finds_card_blocks(self):
        blocks = [
            {"id": 1, "uuid": "u1", "content": "Q #card", "properties": {}, "children": []},
            {"id": 2, "uuid": "u2", "content": "Not a card", "properties": {}, "children": []},
        ]
    ...
    def test_finds_nested_cards(self):
        blocks = [{
            "id": 1, "uuid": "u1", "content": "Parent", "properties": {}, "children": [
                {"id": 2, "uuid": "u2", "content": "Nested #card", "properties": {}, "children": []}
            ]
        }]
        result = _find_flashcards_in_blocks(blocks, {"name": "Test"})
        assert len(result) == 1
...
class TestGetLinkedFlashcards:
    ...
    async def test_no_flashcards_returns_message(self):
        all_pages = [{"id": 1, "uuid": "p1", "name": "mypage", "originalName": "mypage"}]
        client = FakeLogseqClient({
            "get_page_linked_references": [],
            "get_all_pages": all_pages,
            "get_page_blocks_tree": [
                {"id": 1, "uuid": "b1", "content": "Normal block", "properties": {}, "children": []}
            ],
        })
