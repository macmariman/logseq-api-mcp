...
from src.tools.edit_block import edit_block as _run
...
class TestEditBlock:
    async def test_success_message(self):
        ...
        result = await _run(client, _cfg, "block-123", content="updated content")
    ...
    async def test_exception_returns_error(self):
        ...
        result = await _run(ErrorClient(), _cfg, "b", content="text")
